...
export const portal = {
  ...
  welcome: {
    ...
    body: [
      ...
      'ในการส่งผลงานครั้งนี้ ทีมจะต้องเตรียมแอปพลิเคชัน และตอบคำถามที่กำหนด เพื่อให้กรรมการเข้าใจทั้งถึงไอเดีย เทคนิคที่ใช้ และผลกระทบเชิงบวกของผลงานที่ส่ง ขอให้ทุกทีมอ่านรายละเอียดด้านล่างนี้ให้ครบถ้วนก่อนเริ่มพัฒนาผลงานนะครับ',
    ],
  },
