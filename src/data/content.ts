...
export const portal = {
  ...
  detail: {
    ...
    body: 'สร้าง App Playground ที่เล่นจบได้ภายใน 3 นาที ใส่ไอเดียสร้างสรรค์ได้เต็มที่',
    rulesHeading: 'ข้อกำหนดการส่งผลงาน:',
    rules: [
      'พัฒนาแอปด้วย Swift Playgrounds 4.6 ขึ้นไป บน iPad หรือ MacBook',
      'แอปต้องสามารถสาธิตการใช้งานได้ภายใน 3 นาที',
      'แอปต้องไม่พึ่งพาการเชื่อมต่ออินเทอร์เน็ต เนื่องจากการคัดเลือกผลงานจะอยู่ในรูปแบบออฟไลน์',
      'เป็นแอปที่ไม่เคยส่งเข้าแข่งขันหรือนำเสนอที่ใดมาก่อน',
    ...
    questions: [
      {
        id: 'inspiration',
        label:
          'อธิบายแอปของคุณ อะไรคือแรงบันดาลใจในการสร้างแอปนี้ และแอปต้องการแก้ปัญหาในด้านใด',
