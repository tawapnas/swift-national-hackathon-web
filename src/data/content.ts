  ...
  result: {
    qualified: {
      ...
      body: [
        ...
        'เกียรติบัตรการเข้าร่วมกิจกรรมจะจัดส่งให้ในรูปแบบไฟล์ภายในสัปดาห์นี้',
      ],
    ...
    share: {
      ...
      card: {
        ...
        // 1080×1920 branded backdrop (logo, event title, footer contacts).
        background: '/bg_finalist.jpg',
      },
    },
  },
  ...
  finalRound: {
    ...
    documents: {
      ...
      certificate: {
        ...
        note: 'ไฟล์ PDF สำหรับสมาชิกทั้ง 3 คนในทีม',
      },
      invitation: {
  ...
  organizer: {
    ...
    csv: {
      ...
      headers: [
        ...
        'ลิงก์ไฟล์',
        'อุปกรณ์ที่ใช้ทดสอบ',
        // Written Proposal answers — same order as submission.questions above.
        'ภาพรวมผลงาน',
        'แรงบันดาลใจ',
        'แง่มุมทางเทคนิค',
        'สิ่งที่เรียนรู้จากเครื่องมือ AI',
        'การช่วยเหลือชุมชน/สถานศึกษา',
